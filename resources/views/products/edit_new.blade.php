    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl animate-slide-up">
                <div class="px-8 py-8">
                    <div class="mb-8">
                        <h3 class="text-2xl font-bold text-gray-800 mb-2">Edit Product: {{ $product->name }}</h3>
                        <p class="text-gray-600">Update the information below to modify this product.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('product.update', ['product' => $product]) }}" class="space-y-6">
                        ...
                        <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" class="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center">
